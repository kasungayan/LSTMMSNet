...
for (idr in 1 : nrow(df_train)) {
  print(idr)
  OUTPUT_PATH = paste(OUTPUT_DIR, "energy_fourier_test", sep = '/')
  ...
  seasonality_windows_1 = embed(seasonality1[1 : (time_series_length)], input_size)[, input_size : 1]
  seasonality_windows_2 = embed(seasonality2[1 : (time_series_length)], input_size)[, input_size : 1]
  seasonality_windows_3 = embed(seasonality3[1 : (time_series_length)], input_size)[, input_size : 1]
